...
function Payment() {
	...
	return (
		<div className="rounded-md bg-white flex flex-row justify-around items-center w-96">
			<Link
				href=""
				className="bg-[#6461FC] rounded-md"
				>
					{/* Stripe Logo*/}
					<svg x="0px" y="0px" width="108px" height="50px" className="fill-white" viewBox="0 0 468 222.5">
						<g>
							<path d="M414,113.4c0-25.6-12.4-45.8-36.1-45.8c-23.8,0-38.2,20.2-38.2,45.6c0,30.1,17,45.3,41.4,45.3
							...
							<path d="M301.1,67.6c-9.8,0-16.1,4.6-19.6,7.8l-1.3-6.2h-22v116.6l25-5.3l0.1-28.3c3.6,2.6,8.9,6.3,17.7,6.3
							...
							<path d="M146.9,47.6l-24.4,5.2l-0.1,80.1c0,14.8,11.1,25.7,25.9,25.7c8.2,0,14.2-1.5,17.5-3.3V135
								c-3.2,1.3-19,5.9-19-8.9V90.6h19V69.3h-19L146.9,47.6z"/>
							<path d="M79.3,94.7c0-3.9,3.2-5.4,8.5-5.4c7.6,0,17.2,2.3,24.8,6.4V72.2c-8.3-3.3-16.5-4.6-24.8-4.6
